...
if __name__ == '__main__':
    ...
    for e in range(EPISODES):
        self_play = play_game(NUM_CHESS, BATCH_SIZE, model, NUM_SIMULATIONS, render=False)
        ...
        ploss, vloss, ent = trainer.run_train(BUFFER_SIZE, model)
        ...
        model.save_weights("./model/gomoku_{}X{}".format(NUM_CHESS, NUM_CHESS))