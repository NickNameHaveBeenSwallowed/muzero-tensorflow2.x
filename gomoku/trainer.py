...
class ReplayBuffer():
    ...
    def data_augmentation(trajectory):
        ...
        for s_a_p_w in trajectory:
            ...
            t4.append([state_flip_2, action_flip_2, np.reshape(policy_flip_2, newshape=(policy_flip_2.shape[0] * policy_flip_2.shape[1])), winner_flip_2])
            t5.append([state_rot180, action_rot180, np.reshape(policy_rot180, newshape=(policy_rot180.shape[0] * policy_rot180.shape[1])), winner_rot180])
